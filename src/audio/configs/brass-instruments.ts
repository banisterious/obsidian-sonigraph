    ...
    instruments: {
        ...
        trombone: {
            urls: {
                ...
                'Bb2': `As2.${FORMAT_PLACEHOLDER}`,  // Also add flat notation
            ...
            priority: 'medium',
            category: 'brass',
            octaveOffset: -1  // Shift down one octave to match proper trombone range
        },
        ...
        tuba: {
            ...
            effects: ['reverb', 'filter'],  // Match trumpet's effects
            maxVoices: 3,  // Match trumpet's maxVoices
            priority: 'high',  // Match trumpet's priority
            category: 'brass',
            octaveOffset: -1
        }
    }
