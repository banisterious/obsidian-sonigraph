...
const CONFIG = {
  ...
  excludedFiles: [
    'main.css'           // Legacy file (should be removed)
  ]
};
 ...
 */
function generateBuildHeader(componentCount, buildStart) {
  const timestamp = new Date().toISOString().replace('T', ' ').slice(0, 19) + ' UTC';
  
  return `/* ==========================================================================
   Sonigraph Plugin Stylesheet - BUILT VERSION
   ========================================================================== */
...
async function buildCSS() {
  ...
  // Start building
  let buildContent = generateBuildHeader(CONFIG.componentOrder.length, buildStart);
...
async function main() {
  ...
  console.log(chalk.cyan('\n🎨 Sonigraph CSS Build System v1.0.0\n'));
